...
<center> <h2><color= "grey">CARI SISWA BERDASARKAN NISN</h2> </center>
  </div>
...
<?php 
$sql= mysqli_query($koneksi , " SELECT * FROM tb_pembayaran WHERE nisn = '$dta[nisn]' ORDER BY jumlah_bayar ASC ");
$i=1;
